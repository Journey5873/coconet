...
export default function SupportButtonModal({handleSupportButton,isVisible}:SupportButtonModalProps) {
                    ...
                    {nextModalVisible
                        ? (
                            <div style={{textAlign:"center"}}>
                                <StyledSetSelfIntroduce>자신을 소개할 수 있는 짧은 글을 작성해 주세요!</StyledSetSelfIntroduce>
                                <StyledTextArea name="info" id="info"></StyledTextArea>
                                <StyledSupportButton onClick={handleNextModal}>다음</StyledSupportButton>   
                            </div>                
                            )
                        : (
                            <div>
                                ...
                                <div style={{ textAlign: "center", marginTop : 20 }}>
                                    ...
                                    <StyledSingleSelect label="포지션" onChange={handleCarrer} value={carrer} />
                                    <LinkList onSubmit={() => { }} />             
                                </div>        
